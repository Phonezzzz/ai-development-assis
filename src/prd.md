...
**Критический путь**: Ввод задачи → Выбор режима (План/Выполнить) → Взаимодействие с агентами → Использование инструментов → Получение результата

**Ключевые моменты**: 
1. Выбор модели ИИ из списка OpenRouter
2. Настройка TTS (ElevenLabs API)
3. Принятие решения между планированием и немедленным выполнением
4. Подтверждение плана перед выполнением
5. Использование реальных инструментов агентов
...
### Кнопки копирования и прослушивания
