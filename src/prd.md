...
### Динамическая загрузка моделей из OpenRouter
- **Что это делает**: Автоматически загружает все доступные модели ИИ из OpenRouter API
- **Почему это важно**: Предоставляет доступ к самым современным и разнообразным моделям ИИ
- **Критерии успеха**: 
  - Успешная загрузка всех доступных моделей
  - Отображение информации о провайдере, ценах и возможностях
  - Отметка бесплатных моделей
  - Fallback на статический список при ошибках API
